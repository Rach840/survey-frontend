...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn('rounded-lg bg-slate-100 p-1', activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <div
  ...
  return (
    <MotionHighlightItem value={value} className="size-full">
      <motion.button
        ...
        className={cn(
          'inline-flex cursor-pointer items-center size-full justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium text-slate-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white data-[state=active]:text-slate-900 data-[state=active]:shadow-sm',
          className,
        )}
        {...props}
      >
