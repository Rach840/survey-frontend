...
export function LoginPage() {
    return (
        <div className="min-h-screen bg-[#eff6ff] flex items-center justify-center p-4 relative overflow-hidden">
            <div className="absolute top-24 right-32 w-32 h-32 rounded-full bg-gradient-to-br from-[#a5b4fc] to-[#c4b5fd] opacity-60" />
            <div className="absolute bottom-32 left-32 w-48 h-48 rounded-full bg-gradient-to-br from-[#a5b4fc] to-[#c4b5fd] opacity-40" />
